 ...
 */
public class BankCardAdapter extends BaseAdapter<String> {

    public BankCardAdapter(Context ctx, List<String> data) {
        super(ctx, R.layout.item_bank_card, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, final String bankcard) {
...
//        baseViewHolder.setText(R.id.tv_bank_name, bankcard.getBanktype_name());
