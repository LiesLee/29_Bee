...
public class RegistPresenter extends BasePresenterImpl<RegistView> {
    public RegistPresenter(RegistView view) {
        super(view);
    }

    public void register(String sms_code,String mobile, String login_password, String pay_password){
        HttpUtil.requestDefault(CommonProtocol.register(sms_code, mobile, login_password, pay_password), mView, new RequestCallback<String>() {
            @Override
