...
import com.lieslee.bee_29.module.home.ui.adapter.TransactionRecordAdapter;
 ...
 */
@ActivityFragmentInject(contentViewId = R.layout.act_transaction_record, toolbarTitle = R.string.transaction_record)
    public class TransactionRecordActivity extends BaseActivity<RecordPresenter> implements RecordView {
    ...
    protected void initView() {
        ...
        mAdapter = new TransactionRecordAdapter(baseActivity, null);
